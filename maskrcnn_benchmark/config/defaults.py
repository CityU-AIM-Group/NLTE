...
# My
_C.MODEL.CLS_LOSS_FUNC = 'ce'
_C.MODEL.SOFTMAX_DISTANCE = True

# Overall Controller
_C.MODEL.NOISETRANSFER_DA_ON = False
_C.MODEL.NOISEGRADMATCH_ON = False

# PMM
_C.MODEL.PMM_TH = 0.995

# MGRM
_C.MODEL.MGRM_WEIGHT = 0.1

# EAGR
_C.MODEL.EAGR_LR = 10

# MY_HEAD
_C.MODEL.MY_HEAD_CLS_WEIGHT_ON = False
_C.MODEL.CLS_LOSS_WEIGHT = 1.
_C.MODEL.MY_HEAD_VAR_WEIGHT = 0.1
_C.MODEL.MY_HEAD_TM_WEIGHT = 0.1
_C.MODEL.MY_HEAD_UPDATE = 'cos'
_C.MODEL.FISH_PERIOD = 2

_C.MODEL.MGRM_LOSS_FUNC = 'l2'